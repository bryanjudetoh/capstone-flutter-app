      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          ActivitiesCarousel(
            ...
            seeAllFunc: () {Navigator.of(context).pushNamed('/browse-activities', arguments: 'Online Courses');},
            type: 'onlineCourse',
          ),
          ActivitiesCarousel(
            title: AppLocalizations.of(context)!.offlineCourses + ':',
            seeAllFunc: () {Navigator.of(context).pushNamed('/browse-activities', arguments: 'Offline Courses');},
            type: 'offlineCourse',
          ),
          ActivitiesCarousel(
